...
public class Memory_Management {
	...
	public static int FIFO(List<Integer> i, int frame) {
		int[] memory = new int[frame];
		int pagefault = 0;
		int n = 0;
		int index = 0;
		for(n=0;n<i.size();n++) {
	...
	public static int LRU(List<Integer> i, int frame) {
		int[] memory = new int[frame];
		int pagefault = 0;
		int n = 0;
		int index = 0;
	...
	public static int Optimal(List<Integer> i, int frame) {
		int[] memory = new int[frame];
		int pagefault = 0;
		int n = 0;
		int index = 0;
